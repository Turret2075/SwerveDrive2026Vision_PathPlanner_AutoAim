...
import com.team5959.subsystems.SwerveChassis;
    ...
    public class AutoAimPassLeft extends Command{
    private SwerveChassis swerveChassis; 

    private final Translation2d blueLEFTPASS = new Translation2d(3.000, 6.500);
    private final Translation2d redLEFTPASS = new Translation2d(13.500, 1.500);
  ...
  public void execute() {
    ...
    swerveChassis.driveWithHeadingHold(xSpeed, ySpeed, RotateToLeftPass, fieldOriented);//FIXME SI NO FUNCIONA EL HOLDING REGRESAR A METODO DRIVE
